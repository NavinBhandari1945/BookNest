...
class _BookmarkDetailsState extends State<BookmarkDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    Text("Phone Number: ${widget.BookmarkInfoList.phoneNumber ?? ''}"),
    ...
    Text("Price: ${widget.BookmarkInfoList.price?.toStringAsFixed(2) ?? ''}"),
    ...
    Text("Publication Date: ${widget.BookmarkInfoList.publicationDate ?? ''}"),
    ...
    Text("Available Quantity: ${widget.BookmarkInfoList.availableQuantity ?? ''}"),
    Text("Discount Percent: ${widget.BookmarkInfoList.discountPercent?.toStringAsFixed(2) ?? ''}"),
    Text("Discount Start: ${widget.BookmarkInfoList.discountStart ?? ''}"),
    Text("Discount End: ${widget.BookmarkInfoList.discountEnd ?? ''}"),
